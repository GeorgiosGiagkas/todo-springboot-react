...
import com.webservices.todoapp.jwt.JwtTokenUtil;
...
public class JwtAuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest jwtTokenRequest)
        ...
        final UserDetails userDetails= jwtInMemoryUserDetailsService.loadUserByUsername(jwtTokenRequest.getUsername());
